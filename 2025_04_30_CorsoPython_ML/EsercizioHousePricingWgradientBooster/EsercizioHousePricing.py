...
# Caricamento dati
file_path = r'C:\Users\Simxyz\Desktop\DataScienceCarreer\4.ItConsultingGiGroup\CorsoPythonwGithub\SimoneVerrengia_DepositoCorsoPython\30_04_CorsoPython_ML\EsercizioHousePricingWgradientBooster\kc_house_data.csv'
...
# Risultati
results = {
    "Regressione Lineare": {"R2": r2_linear, "RMSE": rmse_linear},
    "Ridge": {"R2": r2_ridge, "RMSE": rmse_ridge},
    "Lasso": {"R2": r2_lasso, "RMSE": rmse_lasso},
    "Gradient Boosting": {"R2": r2_gbr, "RMSE": rmse_gbr},
}
print("\nRisultati dei modelli (R² e RMSE):")

for model, scores in results.items():
    print(f"{model}: R² = {scores['R2']:.4f}, RMSE = {scores['RMSE']:.2f}")
...
# Trasformazione del dizionario in DataFrame corretto
df_results = pd.DataFrame([
    {'Model': model, 'R2': metrics['R2'], 'RMSE': metrics['RMSE']}
