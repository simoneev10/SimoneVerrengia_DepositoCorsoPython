...
# --- 9. Grafico delle Previsioni vs. Valori Reali (Modello Ottimizzato) ---
print("\n--- Grafico Previsioni vs. Valori Reali (Modello Ottimizzato) ---")
...
plt.title("XGBoost (Ottimizzato) - Previsioni vs. Valori Reali")
plt.legend()
plt.grid(True)
plt.show()
...
print(f"Modello Ottimizzato - MSE: {mse_best:.2f}, RMSE: {rmse_best:.2f}, R²: {r2_best:.2f}")